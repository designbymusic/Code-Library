...
$resolutions   = array(2560,480); // the resolution break-points to use (screen widths, in pixels)
$cache_path    = "blah"; // where to store the generated re-sized images. Specify from your document root!
